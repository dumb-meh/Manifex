...
app.include_router(word_parts_workshop_router, prefix="/word_parts_workshop", tags=["adult"])
app.include_router(sentence_builder_router, prefix="/sentence_builder", tags=["adult"])
